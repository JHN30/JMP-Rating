...
Usage Example:
    EXEC silver.load_silver_eurocup;
===============================================================================
*/
CREATE OR ALTER PROCEDURE silver.load_silver_eurocup 
AS
BEGIN
    DECLARE 
        @start_time DATETIME,
    ...
    BEGIN TRY
        ...
        PRINT '------------------------------------------------';
        PRINT 'Loading Eurocup table';
        PRINT '------------------------------------------------';

        -- Loading silver.eurocup_players
        SET @start_time = GETDATE();

        PRINT '>> Truncating Table: silver.eurocup_players';
        TRUNCATE TABLE silver.eurocup_players;

        PRINT '>> Inserting Data Into: silver.eurocup_players';
        INSERT INTO silver.eurocup_players (
            season_player_id,
            season_code,
            player_id,
            player_last_name,
